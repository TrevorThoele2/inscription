...
class JsonStringTestsFixture : public JsonFixture
{
public:
...
SCENARIO_METHOD(JsonStringTestsFixture, "loading from empty string in json", "[json]")
{
    GIVEN("empty json")
    {
        ...
        WHEN("creating input archive")
        {
            ...
            {
                REQUIRE_NOTHROW(CreateRegistered<InputArchive>(json));
            }
        }
        ...
        WHEN("loading value")
        {
            ...
            {
                auto inputArchive = CreateRegistered<InputArchive>(json);
...
SCENARIO_METHOD(JsonStringTestsFixture, "loading basics from string in json", "[json]")
{
    ...
    GIVEN("saved all integers")
    {
        ...
        {
            auto outputArchive = CreateRegistered<OutputArchive>(savedJson);
        ...
        WHEN("loading")
        {
            ...
            {
                auto inputArchive = CreateRegistered<InputArchive>(savedJson);
