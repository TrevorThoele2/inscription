...
namespace Inscription
{
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_multimap<Key, T, Hash, Predicate, Allocator>>::Scriven(ObjectT& object, Format::Binary& format)
    {
        if (format.IsOutput())
        {
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_multimap<Key, T, Hash, Predicate, Allocator>>::Scriven(const std::string& name, ObjectT& object, Format::Json& format)
    {
        if (format.IsOutput())
        {
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator, class Format>
    struct ScribeTraits<std::unordered_multimap<Key, T, Hash, Predicate, Allocator>, Format>
    {
