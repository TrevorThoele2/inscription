...
namespace Inscription
{
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_multimap<Key, T, Hash, Predicate, Allocator>, BinaryArchive>::Scriven(ObjectT& object, ArchiveT& archive)
    {
        if (archive.IsOutput())
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_multimap<Key, T, Hash, Predicate, Allocator>, BinaryArchive>::SaveImplementation(ObjectT& object, ArchiveT& archive)
    {
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_multimap<Key, T, Hash, Predicate, Allocator>, BinaryArchive>::LoadImplementation(ObjectT& object, ArchiveT& archive)
    {
        ContainerSize size;
        archive(size);
