...
namespace Inscription
{
    ...
    void Save(ScribeT& scribe, std::multimap<Key, T, Hash, Alloc>& obj)
    {
    ...
    template<class ScribeT, class Key, class T, class Hash, class Alloc>
    void Load(ScribeT& scribe, std::multimap<Key, T, Hash, Alloc>& obj)
    {
    ...
    template<class ScribeT, class Key, class T, class Hash, class Alloc>
    void Serialize(ScribeT& scribe, std::multimap<Key, T, Hash, Alloc>& obj)
    {
