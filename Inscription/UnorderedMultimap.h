...
namespace inscription
{
    ...
    void Save(Scribe &scribe, std::unordered_multimap<Key, T, Hash, Pred, Alloc> &obj)
    {
    ...
    template<class Key, class T, class Hash, class Pred, class Alloc>
    void Load(Scribe &scribe, std::unordered_multimap<Key, T, Hash, Pred, Alloc> &obj)
    {
    ...
    template<class Key, class T, class Hash, class Pred, class Alloc>
    void Serialize(Scribe &scribe, std::unordered_multimap<Key, T, Hash, Pred, Alloc> &obj)
    {
