...
namespace Inscription
{
    ...
    void Save(BinaryScribe& scribe, std::unordered_multimap<Key, T, Hash, Pred, Alloc>& obj)
    {
    ...
    template<class Key, class T, class Hash, class Pred, class Alloc>
    void Load(BinaryScribe& scribe, std::unordered_multimap<Key, T, Hash, Pred, Alloc>& obj)
    {
