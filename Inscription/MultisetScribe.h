...
namespace Inscription
{
    ...
    template<class Key, class Predicate, class Allocator>
    void Scribe<std::multiset<Key, Predicate, Allocator>>::Scriven(ObjectT& object, Format::Binary& format)
    {
        if (format.IsOutput())
        {
    ...
    template<class Key, class Predicate, class Allocator>
    void Scribe<std::multiset<Key, Predicate, Allocator>>::Scriven(const std::string& name, ObjectT& object, Format::Json& format)
    {
        if (format.IsOutput())
        {
    ...
    struct ScribeTraits<std::multiset<Key, Predicate, Allocator>, Format>
    {
