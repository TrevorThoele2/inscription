...
namespace Inscription
{
    ...
    template<class Key, class Predicate, class Allocator>
    void Scribe<std::set<Key, Predicate, Allocator>>::Scriven(ObjectT& object, Archive::Binary& archive)
    {
        if (archive.IsOutput())
        {
    ...
    template<class Key, class Predicate, class Allocator>
    void Scribe<std::set<Key, Predicate, Allocator>>::Scriven(const std::string& name, ObjectT& object, Archive::Json& archive)
    {
        if (archive.IsOutput())
        {
