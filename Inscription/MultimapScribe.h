...
namespace Inscription
{
    ...
    template<class Key, class T, class Hash, class Allocator>
    void Scribe<std::multimap<Key, T, Hash, Allocator>>::Scriven(ObjectT& object, BinaryArchive& archive)
    {
        if (archive.IsOutput())
        {
    ...
    template<class Key, class T, class Hash, class Allocator>
    void Scribe<std::multimap<Key, T, Hash, Allocator>>::Scriven(const std::string& name, ObjectT& object, JsonArchive& archive)
    {
        if (archive.IsOutput())
        {
