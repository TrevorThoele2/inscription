...
namespace Inscription
{
    ...
    class Scribe<std::list<T, Allocator>, BinaryArchive> final :
        public ObjectScribe<std::list<T, Allocator>, BinaryArchive>
    {
    private:
        using BaseT = ObjectScribe<std::list<T, Allocator>, BinaryArchive>;
    public:
    ...
    template<class T, class Allocator>
    void Scribe<std::list<T, Allocator>, BinaryArchive>::ScrivenImplementation(ObjectT& object, ArchiveT& archive)
    {
        if (archive.IsOutput())
    ...
    template<class T, class Allocator>
    class Scribe<std::list<T, Allocator>, JsonArchive> final :
        public ObjectScribe<std::list<T, Allocator>, JsonArchive>
    {
    private:
        using BaseT = ObjectScribe<std::list<T, Allocator>, JsonArchive>;
    public:
        using typename BaseT::ObjectT;
        using typename BaseT::ArchiveT;
    ...
    template<class T, class Allocator>
    void Scribe<std::list<T, Allocator>, JsonArchive>::ScrivenImplementation(const std::string& name, ObjectT& object, ArchiveT& archive)
    {
        if (archive.IsOutput())
    ...
    template<class T, class Allocator>
    void Scribe<std::list<T, Allocator>, JsonArchive>::SaveImplementation(const std::string& name, ObjectT& object, ArchiveT& archive)
    {
    ...
    template<class T, class Allocator>
    void Scribe<std::list<T, Allocator>, JsonArchive>::LoadImplementation(const std::string& name, ObjectT& object, ArchiveT& archive)
    {
        object.clear();
