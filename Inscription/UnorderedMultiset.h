...
namespace Inscription
{
    ...
    void Save(BinaryScribe& scribe, std::unordered_multiset<Key, Hash, Pred, Alloc>& obj)
    {
    ...
    template<class Key, class Hash, class Pred, class Alloc>
    void Load(BinaryScribe& scribe, std::unordered_multiset<Key, Hash, Pred, Alloc>& obj)
    {
