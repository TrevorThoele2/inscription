...
namespace Inscription
{
    ...
    class Scribe<std::unordered_map<Key, T, Hash, Predicate, Allocator>, BinaryArchive> final :
        public ObjectScribe<std::unordered_map<Key, T, Hash, Predicate, Allocator>, BinaryArchive>
    {
    private:
        using BaseT = ObjectScribe<std::unordered_map<Key, T, Hash, Predicate, Allocator>, BinaryArchive>;
    public:
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_map<Key, T, Hash, Predicate, Allocator>, BinaryArchive>::ScrivenImplementation(
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_map<Key, T, Hash, Predicate, Allocator>, BinaryArchive>::SaveImplementation(
        ObjectT& object, ArchiveT& archive)
    {
    ...
    template<class Key, class T, class Hash, class Predicate, class Allocator>
    void Scribe<std::unordered_map<Key, T, Hash, Predicate, Allocator>, BinaryArchive>::LoadImplementation(
        ObjectT& object, ArchiveT& archive)
    {
        ContainerSize size;
        archive(size);
    ...
    class Scribe<std::unordered_map<Key, T, Hash, Allocator>, JsonArchive> final :
        public ObjectScribe<std::unordered_map<Key, T, Hash, Allocator>, JsonArchive>
    {
    private:
        using BaseT = ObjectScribe<std::unordered_map<Key, T, Hash, Allocator>, JsonArchive>;
    public:
        using typename BaseT::ObjectT;
        using typename BaseT::ArchiveT;
    ...
    template<class Key, class T, class Hash, class Allocator>
    void Scribe<std::unordered_map<Key, T, Hash, Allocator>, JsonArchive>::ScrivenImplementation(const std::string& name, ObjectT& object, ArchiveT& archive)
    {
        if (archive.IsOutput())
    ...
    template<class Key, class T, class Hash, class Allocator>
    void Scribe<std::unordered_map<Key, T, Hash, Allocator>, JsonArchive>::SaveImplementation(const std::string& name, ObjectT& object, ArchiveT& archive)
    {
    ...
    template<class Key, class T, class Hash, class Allocator>
    void Scribe<std::unordered_map<Key, T, Hash, Allocator>, JsonArchive>::LoadImplementation(const std::string& name, ObjectT& object, ArchiveT& archive)
    {
        object.clear();
